...
//import org.assertj.core.util.diff.DefaultPatch;
//
///**
...
//   */
//  public DefaultPatch<T> diff(final List<T> original, final List<T> revised) {
...
//          j++;
//        }
//        if (i > node.i) node = new SnakeNode(i, j, node);
//
...
//
//  /**
//   * Constructs a {@link DefaultPatch} from a difference path.
//   *
//   * @param path The path.
//   * @param orig The original sequence.
//   * @param rev The revised sequence.
...
//   */
//  public DefaultPatch<T> buildRevision(PathNode path, List<T> orig, List<T> rev) {
//    checkArgument(path != null, "path is null");
//    checkArgument(orig != null, "original sequence is null");
//    checkArgument(rev != null, "revised sequence is null");
//
//    DefaultPatch<T> patch = new DefaultPatch<>();
//    if (path.isSnake())
//      path = path.prev;

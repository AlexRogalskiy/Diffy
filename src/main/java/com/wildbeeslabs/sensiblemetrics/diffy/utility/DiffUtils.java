...
//
//import com.wildbeeslabs.sensiblemetrics.diffy.common.entry.impl.delta.DefaultPatch;
...
//     */
//    public static <T> DefaultPatch<T> diff(List<T> original, List<T> revised) {
...
//     * revised sequences. Never {@code null}.
//     */
//    public static <T> DefaultPatch<T> diff(List<T> original, List<T> revised, DiffAlgorithm<T> algorithm) {
...
//     */
//    public static <T> List<T> patch(List<T> original, DefaultPatch<T> patch)
...
//     */
//    public static DefaultPatch<String> parseUnifiedDiff(List<String> diff) {
...
//                                                   String revised, List<String> originalLines, DefaultPatch<String> patch,
//                                                   int contextSize) {

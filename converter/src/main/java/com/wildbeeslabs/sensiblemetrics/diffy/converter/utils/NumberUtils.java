...
public class NumberUtils {
    ...
    static {
        final Set<Class<?>> numberTypes = new HashSet<>(8);
    ...
    public static <T extends Number> T convertNumberToTargetClass(Number number, Class<T> targetClass) throws IllegalArgumentException {
        ...
        ValidationUtils.notNull(number, "Number must not be null");
        ValidationUtils.notNull(targetClass, "Target class must not be null");
    ...
    public static <T extends Number> T parseNumber(String text, Class<T> targetClass) {
        ValidationUtils.notNull(text, "Text must not be null");
        ValidationUtils.notNull(targetClass, "Target class must not be null");

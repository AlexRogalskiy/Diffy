...
public class StringReplacerUtils {
     ...
     * method.</p>
     */
    private static transient StringReplacerUtils instance = null;
    /**
    ...
    /**
     * <p>Return a fully configured {@link StringReplacerUtils} instance that can be used
     * for performing transformations.</p>
     */
    public static StringReplacerUtils getInstance() {

        if (instance == null) {
            instance = new StringReplacerUtils();
        }
        return instance;

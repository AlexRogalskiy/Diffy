...
import com.wildbeeslabs.sensiblemetrics.diffy.generator.service.StringGenerator;
...
import static com.wildbeeslabs.sensiblemetrics.diffy.generator.utils.RFC4122.Namespaces.URL;
...
public final class RFC4122 {
    ...
    private abstract static class NameBasedUUIDGenerator extends AbstractUUIDGenerator {
        ...
        public UUID generate(SourceOfRandomness random, GenerationStatus status) {
            digest.reset();
            digest.update((namespace == null ? URL : namespace.value()).bytes);

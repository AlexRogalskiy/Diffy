...
import com.wildbeeslabs.sensiblemetrics.diffy.generator.exception.GenerateOperationException;
...
import com.wildbeeslabs.sensiblemetrics.diffy.generator.interfaces.Gen;
...
import static com.wildbeeslabs.sensiblemetrics.diffy.generator.utils.Reflection.*;
...
public abstract class Generator<T> implements Gen<T>, Shrink<T> {
    ...
    protected Generator(final Class<T> type) {
...
//    }
    ...
    private void configureStrict(
        ...
        configure(
            ...
            configuration,
            ex -> {
                throw new GenerateOperationException(
                    String.format(
